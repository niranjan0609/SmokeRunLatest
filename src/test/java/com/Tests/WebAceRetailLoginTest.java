...
public class WebAceRetailLoginTest extends TestBase {

    private static final Logger log = LogManager.getLogger(WebAceRetailLoginTest.class);
    ...
    @Test(enabled=true)
    public void WebAceRetailPortalTest(String username, String password) throws InterruptedException {
